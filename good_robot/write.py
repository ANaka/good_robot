# AUTOGENERATED! DO NOT EDIT! File to edit: 02_write.ipynb (unless otherwise specified).

__all__ = ['DEFAULT_PAGE_WIDTH', 'DEFAULT_PAGE_HEIGHT', 'DEFAULT_PAGE_UNIT', 'DEFAULT_VIEW_BOX_MARGIN',
           'STROKE_THICKNESS', 'PLOT_COLORS', 'calculate_view_box', 'layer_to_path', 'plot_to_svg', 'layer_to_svg',
           'write_plot']
